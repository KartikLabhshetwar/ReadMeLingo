      ...
      <div className="self-stretch px-6 md:px-24 py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
        <div className="w-full max-w-[586px] px-6 py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4 shadow-none">
          ...
          <div className="self-stretch text-center text-[#605A57] text-base font-normal leading-7 font-sans">
            ReadMeLingo is completely free and open source. You only need a Lingo.dev API key
            <br />
            for translations. Install from npm and start translating in minutes.
          </div>
        </div>
      </div>
            ...
            <div className="flex-1 max-w-full md:max-w-none self-stretch px-6 py-5 bg-[#37322F] border border-[rgba(50,45,43,0.12)] border-[rgba(55,50,47,0.12)] overflow-hidden flex flex-col justify-start items-start gap-12">
              ...
              <div className="self-stretch flex flex-col justify-start items-center gap-9">
                <div className="self-stretch flex flex-col justify-start items-start gap-2">
                  <div className="text-[#FBFAF9] text-lg font-medium leading-7 font-sans">ReadMeLingo</div>
                  <div className="w-full max-w-[242px] text-[#B2AEA9] text-sm font-normal leading-5 font-sans">
                    Free and open source CLI tool for translating documentation.
                  </div>
                </div>
                ...
                {/* CTA Button */}
                <a href="https://www.npmjs.com/package/readmelingo" target="_blank" rel="noopener noreferrer" className="self-stretch">
                  <div className="self-stretch px-4 py-[10px] relative bg-[#FBFAF9] shadow-[0px_2px_4px_rgba(55,50,47,0.12)] overflow-hidden rounded-[99px] flex justify-center items-center cursor-pointer hover:bg-[#F5F3F1] transition-colors">
